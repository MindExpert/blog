...
export default class Chat {
    ...
    sendMessageToServer() {
        ...
        axios.post("/send-chat-message", { text_value: this.chatField.value });

        this.chatLog.insertAdjacentHTML("beforeend", DOMPurify.sanitize(`<div class="chat-self">
                <div class="chat-message">
                    <div class="chat-message-inner">${test.textContent}</div>
                </div>
                <img class="chat-avatar avatar-tiny" src="${this.avatar}" alt="img">
            </div>`)
        );
        ...
        this.chatLog.insertAdjacentHTML("beforeend", DOMPurify.sanitize(`
            <div class="chat-other">
                <a href="/profile/${data.username}">
                    <img class="avatar-tiny" src="${data.avatar}" alt="${data.username}">
                </a>
                <div class="chat-message">
